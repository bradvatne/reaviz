...
export const sankeyNodes = [
  ...
  { title: 'Solid' },
  { title: 'Gas' },
  { title: 'Biofuel imports' },
  { title: 'Biomass imports' },
  { title: 'Coal imports' },
  { title: 'Coal' },
  { title: 'Coal reserves' },
  { title: 'District heating' },
  { title: 'Industry' },
  { title: 'Heating and cooling - commercial' },
  { title: 'Heating and cooling - homes' },
  { title: 'Electricity grid' },
  { title: 'Over generation / exports' },
  { title: 'H2 conversion' },
  { title: 'Road transport' },
  { title: 'Agriculture' },
  { title: 'Rail transport' },
  { title: 'Lighting & appliances - commercial' },
  { title: 'Lighting & appliances - homes' },
  { title: 'Gas imports' },
  { title: 'Ngas' },
  { title: 'Gas reserves' },
